...
// Source: webook\internal\web\jwt\types.go
//
// Generated by this command:
//
//	mockgen -source=webook\internal\web\jwt\types.go -package=jwtmocks -destination=webook\internal\web\jwt\mocks\handler.mock.go
//
